...
class OrderQueueServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Enqueue = channel.unary_unary(
                ...
                request_serializer=utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.SerializeToString,
        ...
        self.Dequeue = channel.unary_unary(
                ...
                response_deserializer=utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.FromString,
                )
...
def add_OrderQueueServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Enqueue': grpc.unary_unary_rpc_method_handler(
                    servicer.Enqueue,
                    request_deserializer=utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.FromString,
            ...
            'Dequeue': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.SerializeToString,
            ),
    }
...
class OrderQueueService(object):
    ...
    def Enqueue(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/order_queue.OrderQueueService/Enqueue',
            utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.SerializeToString,
    ...
    def Dequeue(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/order_queue.OrderQueueService/Dequeue',
            ...
            utils_dot_pb_dot_order__queue_dot_order__queue__pb2.Order.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
